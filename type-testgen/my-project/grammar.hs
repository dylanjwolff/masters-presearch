...
action_5 (20) = happyShift action_2
...
action_6 (20) = happyShift action_2
...
happyReduction_2 (HappyTerminal (TokenType happy_var_1))
	 =  HappyAbsSyn4
		 (Type happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenColons -> cont 5;
	TokenArrow -> cont 6;
	TokenBigArrow -> cont 7;
	TokenType happy_dollar_dollar -> cont 8;
	TokenClassMeta -> cont 9;
	TokenTypeMeta -> cont 10;
	TokenDataMeta -> cont 11;
	TokenEquals -> cont 12;
	TokenWhere -> cont 13;
	TokenOr -> cont 14;
	TokenOSB -> cont 15;

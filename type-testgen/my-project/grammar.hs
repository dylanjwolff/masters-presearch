...
happyExpList = Happy_Data_Array.listArray (0,152) ([28672,272,32768,8,0,0,544,0,32785,0,0,0,0,0,54280,16384,1696,512,53,44308,5,0,1024,106,20512,3,0,0,0,46160,32790,46531,4096,424,0,2,0,0,0,49600,88,0,16384,1696,512,53,8192,32770,3392,1024,106,20512,16387,24257,2560,734,41024,32774,46466,0,0,0,0,27397,1,8,0,0,4096,20481,5816,32768,128,43024,40961,11360,0,136,16384,4,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Decl","CDecl","FDecl","FDecls","TypeExp","'::'","'->'","'=>'","type","class_decl","type_decl","data_decl","'='","where","'|'","'['","']'","'('","')'","'*'","name","fname","','","%eof"]
        bit_start = st * 27
        bit_end = (st + 1) * 27
...
action_4 (6) = happyGoto action_20
action_4 _ = happyFail (happyExpListPerState 4)

action_5 (9) = happyShift action_19
...
action_9 (8) = happyGoto action_17
...
action_11 (10) = happyShift action_25
action_11 (12) = happyShift action_12
action_11 (16) = happyShift action_33
...
action_13 (8) = happyGoto action_32
...
action_14 (8) = happyGoto action_31
...
action_23 (11) = happyShift action_43
...
action_25 (8) = happyGoto action_42
...
action_27 (25) = happyShift action_5
...
action_28 (8) = happyGoto action_39
...
action_29 (8) = happyGoto action_38
...
action_31 (8) = happyGoto action_24
action_31 _ = happyFail (happyExpListPerState 31)

action_32 (10) = happyShift action_25
action_32 (12) = happyShift action_12
action_32 (18) = happyShift action_28
action_32 (19) = happyShift action_13
action_32 (20) = happyShift action_35
...
action_38 (8) = happyGoto action_24
...
action_39 (8) = happyGoto action_24
action_39 _ = happyReduce_15

action_40 (21) = happyShift action_4
action_40 (25) = happyShift action_5
...
action_41 (18) = happyShift action_28
...
action_41 (8) = happyGoto action_24
...
action_42 (8) = happyGoto action_24
action_42 _ = happyReduce_17

action_43 (12) = happyShift action_12
...
action_44 (8) = happyGoto action_24
...
action_46 (6) = happyGoto action_21
...
happyReduction_13 (HappyTerminal (TokenType happy_var_1))
	 =  HappyAbsSyn8
		 (Type happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenColons -> cont 9;
	TokenArrow -> cont 10;
	TokenBigArrow -> cont 11;
	TokenType happy_dollar_dollar -> cont 12;
	TokenClassMeta -> cont 13;
	TokenTypeMeta -> cont 14;
	TokenDataMeta -> cont 15;
	TokenEquals -> cont 16;
	TokenWhere -> cont 17;
	TokenOr -> cont 18;
	TokenOSB -> cont 19;
	...
	TokenCB -> cont 22;
	TokenAny -> cont 23;
	TokenName happy_dollar_dollar -> cont 24;
	TokenFName happy_dollar_dollar -> cont 25;
	TokenComma -> cont 26;
	_ -> happyError' ((tk:tks), [])
	}
